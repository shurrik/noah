        ...
        <ul id="bjui-hnav-navbar">
            ...
            <li><a href="javascript:;" data-toggle="slidebar"><i class="fa fa-table"></i> 表格</a>
                <ul id="bjui-hnav-tree2" class="ztree ztree_main" data-toggle="ztree" data-on-click="MainMenuClick" data-expand-all="true" data-noinit="true">
                    ...
                    -->
					<li data-id="21" data-pid="2" data-url="${wwwroot}/admin/user" data-tabid="user">固定表头表格</li>                    
                        ...
                        <div id="bjui-collapse0" class="panel-collapse panelContent collapse in">
                            <div class="panel-body" >
                                <ul id="bjui-tree0" class="ztree ztree_main" data-toggle="ztree" data-on-click="MainMenuClick" data-expand-all="true">
									...
									<#--
									<li data-id="11" data-pid="1" data-url="${wwwroot}/admin/docform/list" data-tabid="docform">公文单管理</li>	
									-->								
									<li data-id="12" data-pid="1" data-url="${wwwroot}/admin/docrecdept/list" data-tabid="docrecdept">收文部门管理</li>
									<#--
									<li data-id="13" data-pid="1" data-url="${wwwroot}/admin/sendform/list" data-tabid="sendform">发文管理</li>	
									-->
									<li data-id="13" data-pid="1" data-url="${wwwroot}/admin/sendform/listdraft" data-tabid="sendform">发文起草</li>									
									<#--								
									<li data-id="14" data-pid="1" data-url="${wwwroot}/admin/recform/list" data-tabid="recform">收文管理</li>
									-->
									...
									<li data-id="19" data-pid="1" data-url="${wwwroot}/admin/recform/listrecord" data-tabid="recformrecord">收文归档</li>
									<li data-id="20" data-pid="1" data-url="${wwwroot}/admin/sendform/listrecord" data-tabid="sendformrecord">发文归档</li>
									<li data-id="21" data-pid="1" data-url="${wwwroot}/admin/message/list" data-tabid="message">消息</li>
...
<#--
                                    ...
                                    <li data-id="20" data-pid="2" data-url="table.html" data-tabid="table">普通表格</li>
                                    <li data-id="21" data-pid="2" data-url="table-fixed.html" data-tabid="table-fixed">固定表头表格</li>
									<li data-id="21" data-pid="2" data-url="${wwwroot}/admin/user/list" data-tabid="user">固定表头表格</li>                                    
                                    <li data-id="22" data-pid="2" data-url="table-edit.html" data-tabid="table-edit">可编辑表格</li>
                                    <li data-id="3" data-pid="0">弹出窗口</li>
                                    <li data-id="30" data-pid="3" data-url="dialog.html" data-tabid="dialog">弹出窗口</li>
                                    <li data-id="31" data-pid="3" data-url="alert.html" data-tabid="alert">信息提示</li>
