...
function ($stateProvider, $urlRouterProvider, $controllerProvider, $compileProvider, $filterProvider, $provide, $ocLazyLoadProvider, jsRequires) {
    ...
    }).state('app.admin.hostlist', {
        url: "/hostlist",
        templateUrl: "assets/views/biz/admin/host/list.html",
        resolve: loadSequence('ngTable', 'hostCtrl'),
        title: '主机',
        ncyBreadcrumb: {
            label: '主机'
        }
    }).state('app.admin.artifactlist', {
        url: "/artifactlist",
        templateUrl: "assets/views/biz/admin/artifact/list.html",
        resolve: loadSequence('ngTable', 'artifactCtrl'),
        title: '构件',
        ncyBreadcrumb: {
            label: '构件'
        }
    }).state('app.admin.templatelist', {
        url: "/templatelist",
        templateUrl: "assets/views/biz/admin/template/list.html",
        resolve: loadSequence('ngTable', 'templateCtrl'),
        title: '模板',
        ncyBreadcrumb: {
            label: '模板'
        }
    }).state('app.admin.steplist', {
        url: "/steplist",
        templateUrl: "assets/views/biz/admin/step/list.html",
        resolve: loadSequence('ngTable', 'stepCtrl'),
        title: '步骤',
        ncyBreadcrumb: {
            label: '步骤'
        }
    }).state('app.admin.commandlist', {
        url: "/commandlist",
        templateUrl: "assets/views/biz/admin/command/list.html",
        resolve: loadSequence('ngTable', 'commandCtrl'),
        title: '命令',
        ncyBreadcrumb: {
            label: '命令'
        }
    }).state('app.admin.templatesteplist', {
        url: "/templatesteplist",
        templateUrl: "assets/views/biz/admin/templatestep/list.html",
        resolve: loadSequence('ngTable', 'templatestepCtrl'),
        title: '模板步骤',
        ncyBreadcrumb: {
            label: '模板步骤'
        }
    }).state('app.admin.stepcommandlist', {
        url: "/stepcommandlist",
        templateUrl: "assets/views/biz/admin/stepcommand/list.html",
        resolve: loadSequence('ngTable', 'stepcommandCtrl'),
        title: '步骤命令',
        ncyBreadcrumb: {
            label: '步骤命令'
        }
