...
app.constant('JS_REQUIRES', {
    ...
    scripts: {
        ...
        'hostCtrl': 'assets/js/controllers/biz/admin/hostCtrl.js',
        'artifactCtrl': 'assets/js/controllers/biz/admin/artifactCtrl.js',
        'templateCtrl': 'assets/js/controllers/biz/admin/templateCtrl.js',
        'stepCtrl': 'assets/js/controllers/biz/admin/stepCtrl.js',
        'commandCtrl': 'assets/js/controllers/biz/admin/commandCtrl.js',
        'templatestepCtrl': 'assets/js/controllers/biz/admin/templatestepCtrl.js',
        'stepcommandCtrl': 'assets/js/controllers/biz/admin/stepcommandCtrl.js',
