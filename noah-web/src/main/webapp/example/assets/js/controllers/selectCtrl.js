...
app.controller('SelectCtrl', ["$scope", "$http", "$timeout", function ($scope, $http, $timeout) {
    ...
    $timeout(function () {
        $scope.peopleAsync = [
             ...
             { name: 'Estefan铆a', email: 'estefania@email.com', age: 21, country: 'Argentina' },
             ...
             { name: 'Nicol谩s', email: 'nicole@email.com', age: 43, country: 'Colombia' }
        ];
    }, 3000);
    ...
    $scope.people = [
      ...
      { name: 'Natasha', email: 'natasha@email.com', age: 54, country: 'Ecuador' },
      { name: 'Michael', email: 'michael@email.com', age: 15, country: 'Colombia' },
      { name: 'Nicol谩s', email: 'nicolas@email.com', age: 43, country: 'Colombia' }
    ];
