...
app.factory('SelectFx', ["$http", function ($http) {
    ...
    SelectFx.prototype._initEvents = function () {
        ...
        // close the select element if the target it脗麓s not the select element or one of its descendants..
    ...
    SelectFx.prototype._changeOption = function () {
        ...
        // change native select element脗麓s value
